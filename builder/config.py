...
config = {
    ...
    'ignored_url_snapshot_path': os.path.join(dirname, '../data/snapshots/ignored-removed.csv'),
    'non_gov_url_snapshot_path': os.path.join(dirname, '../data/snapshots/nonfederal-removed.csv'),
